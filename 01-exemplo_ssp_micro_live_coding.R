...
base_bruta <- readxl::read_xls("material_do_curso/dados/DadosBO_2021_3(ROUBO DE VEÍCULOS))_completa.xls")

base_bruta <- readr::read_delim("material_do_curso/dados/DadosBO_2021_3(ROUBO DE VEÍCULOS))_completa.xls", delim = "\t")

base_bruta <- read.delim("material_do_curso/dados/DadosBO_2021_3(ROUBO DE VEÍCULOS))_completa.xls", sep = "\t", stringsAsFactors = FALSE)

readr::guess_encoding("material_do_curso/dados/DadosBO_2021_3(ROUBO DE VEÍCULOS))_completa.xls")

base_bruta <- readr::read_delim("material_do_curso/dados/DadosBO_2021_3(ROUBO DE VEÍCULOS))_completa.xls", 
                                delim = "\t", 
                                locale = readr::locale(encoding = "UTF-16LE "))

base_bruta <- read.delim("material_do_curso/dados/DadosBO_2021_3(ROUBO DE VEÍCULOS))_completa.xls", 
